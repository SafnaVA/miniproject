...
$canceled_bookings_sql =  "SELECT b.event_id,b.event_name, b.full_name, b.location,b.event_date_from,b.event_date_to, b.start_time, b.end_time FROM booking b
JOIN signup s
ON  b.userid=s.userid
WHERE 
B.event_date_from = '2024-12-29' AND  (s.action != 'blocked' OR s.action IS NULL)";
        ...
        <?php if ($result && $result->num_rows > 0): ?>
            <?php while ($row = $result->fetch_assoc()): ?>
                <tr>
                    ...
                    <td><?php echo $row['event_date_from'];?></td>
